// Disclaimer: This code was copied from github
// Credit: https://github.com/Habrador/Self-driving-vehicle/tree/master
...
namespace dubins
{
    ...
    public class DubinsGeneratePaths
    {
        ...
        List<DubinsPath> pathDataList = new List<DubinsPath>();


        //Get all valid Dubins paths sorted from shortest to longest
        public List<DubinsPath> GetAllDubinsPaths(Vector3 startPos, float startHeading, Vector3 goalPos, float goalHeading)
        {
        ...
        void Get_RSR_Length()
        {
            ...
            //Save the data
            var pathData = new DubinsPath(length1, length2, length3, startTangent, goalTangent, PathType.RSR)
            {
        ...
        void Get_LSL_Length()
        {
            ...
            //Save the data
            var pathData = new DubinsPath(length1, length2, length3, startTangent, goalTangent, PathType.LSL)
            {
                //We also need this data to simplify when generating the final path
                segment2Turning = false
            };
        ...
        void Get_RSL_Length()
        {
            ...
            //Save the data
            var pathData = new DubinsPath(length1, length2, length3, startTangent, goalTangent, PathType.RSL)
            {
                //We also need this data to simplify when generating the final path
                segment2Turning = false
            };
        ...
        void Get_LSR_Length()
        {
            ...
            //Save the data
            var pathData = new DubinsPath(length1, length2, length3, startTangent, goalTangent, PathType.LSR)
            {
                //We also need this data to simplify when generating the final path
                segment2Turning = false
            };
        ...
        void Get_RLR_Length()
        {
            ...
            //Save the data
            var pathData = new DubinsPath(length1, length2, length3, startTangent, goalTangent, PathType.RLR)
            {
                //We also need this data to simplify when generating the final path
        ...
        void Get_LRL_Length()
        {
            ...
            //Save the data
            var pathData = new DubinsPath(length1, length2, length3, startTangent, goalTangent, PathType.LRL)
            {
                //We also need this data to simplify when generating the final path
                segment2Turning = true
            };
